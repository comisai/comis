 ...
 *
 * Budget:
 *   - 199,200 bytes minified (`BUDGET_MINIFIED_BYTES`)
 ...
 *
 * The reviewed schema includes bounded discovery-activation diagnostics in
 * incident reports. The generated bundle occupies 199,153B, leaving 47B of
 * minified headroom; its gzipped size remains far below the independent
 * wire-size budget. The cap stays close to the measured total so the ratchet
 * continues to reject unreviewed growth.
 */
export const BUDGET_MINIFIED_BYTES = 199_200;
