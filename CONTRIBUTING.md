...
Comis is a pnpm monorepo with 12 packages in the `packages/` directory. Each package has its own `package.json`, source code, and tests. See the [Developer Guide](https://comis.mintlify.app/developer-guide/index) for detailed architecture documentation and package descriptions.
