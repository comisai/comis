...
python3 scripts/generate.py \
  --script-file ~/.comis/workspace/tech-explainer-script.json \
  --output-file ~/.comis/workspace/tech-explainer-podcast.mp3 \
  --transcript-file ~/.comis/workspace/tech-explainer-transcript.md
```
