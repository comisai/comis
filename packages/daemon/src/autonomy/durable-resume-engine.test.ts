...
/** The arm seams pointed at a real temp workspace (real existsSync). */
function orchSeams(ws: string | undefined): OrchestrateResumeSeams {
  return { workspaceFor: () => ws, fileExists: (p) => existsSync(p) };
}
