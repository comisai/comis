...
async function bootAgents(
  ...
  const {
    ...
    activeRunRegistry, canaryFallbackSecret, injectionRateLimiter, learnedSkillStore, // learnedSkillStore (v2.26 SURFACE-01/03) -> setupAgents -> the getPromptSkillsXml surface seam
