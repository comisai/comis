...
/** The assembled autonomy block (shape-identical to FleetHealthReport.autonomy). */
 ...
 * read back from the synthetic-excluded `reduceFleetWindow` (NEVER re-derived here).
 */
