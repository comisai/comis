 ...
 * system` report, a sibling of `system-autonomy.ts`. Reduces the content-free
...
/** The assembled wake-gate block (shape-identical to SystemHealthReport.cronWakeGate). */
export type CronWakeGateSlice = NonNullable<SystemHealthReport["cronWakeGate"]>;
