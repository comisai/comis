...
// @allow-throw: @allow-throw boundary: scheduler-execution state-tracking guard; consumed via daemon scheduler wiring catch (daemon.ts bootstrap boundary) (Phase 41 TS-HYG-07).
/**
