...
describe("filterResponse", () => {
  ...
  describe("helper-delegation + public-surface preservation", () => {
    ...
    it("filterResponse handles HEARTBEAT_OK / [SILENT] / substantive text", () => {
      ...
      const silent = filterResponse("[SILENT] x");
      expect(silent.shouldDeliver).toBe(false);
      expect(silent.suppressedBy).toBe("SILENT");

      const hello = filterResponse("Hello");
      expect(hello.shouldDeliver).toBe(true);
