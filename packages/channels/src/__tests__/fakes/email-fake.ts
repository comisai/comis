 ...
 * the Email DigestOnly renderer (CHAN-10 / CHAN-11; §18.3 "fake adapter records
 * every method call").
 *
 * Mirrors `createFakeIMessageAdapter` (the Phase-72 send-only template) but for
 * the DigestOnly shape:
