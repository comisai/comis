 ...
 * `"none"`) as a safety net for *future* plugins. For the 12 in-tree
...
const EXPECTED: readonly ExpectedCaps[] = [
  ...
  { dir: "googlechat", typing: false, threads: false, buttons: "none" },
];
...
describe("every in-tree channel plugin declares typing/threads/buttons explicitly", () => {
  it("walks all 12 plugins and finds typing/threads/buttons as own-properties (not schema defaults)", () => {
    // Sanity: the matrix walks exactly the 12 in-tree plugins.
