...
describe("classifyGoogleChatError", () => {
  ...
  it("classifies a 401 response as a non-retryable auth failure that names the grant/scope", () => {
  ...
  it("classifies a 429 response as a retryable platform failure that surfaces the status", () => {
