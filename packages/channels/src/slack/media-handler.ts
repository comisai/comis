...
// @allow-throw: @allow-throw boundary: Slack media-handler boundary throws; consumed by slack-resolver/adapter try/catch chain converting to ResolvedMedia Result (Phase 41 TS-HYG-07).
/**
