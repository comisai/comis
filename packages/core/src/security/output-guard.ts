...
const SECRET_PATTERNS: ReadonlyArray<{ name: string; regex: RegExp; severity: "critical" | "warning" }> = [
  ...
  { name: "bearer_token", regex: BEARER_TOKEN, severity: "critical" },   // R4: was "warning" — now REDACTS
  { name: "hf_token", regex: /\bhf_[A-Za-z0-9_]{18,}\b/g, severity: "critical" },  // R4: bare hf_ (keystone PREFIX_MIN_BODY_LENGTHS["hf_"] = 18)
