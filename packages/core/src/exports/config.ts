...
export {
  ...
  // Proxy config schema (global egress proxy)
  ProxyConfigSchema,
  ProxyEndpointSchema,
  ProxyLoopbackModeSchema,
  // Orchestration authoring gate (v2.27) — top-level, default-OFF.
...
export type {
  ...
  StorageModePreRead,
  // Proxy config types (global egress proxy)
  ProxyConfig,
  ProxyEndpoint,
  // Orchestration authoring gate (v2.27)
  OrchestrationConfig,
