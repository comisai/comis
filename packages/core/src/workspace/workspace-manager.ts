...
// @allow-throw: ENOENT re-raise inside writeIfMissing 'wx' flag fallback (line 103); EEXIST is the silent-skip path, all other errors propagate. Consumed at workspace-init boundary (CLI wizard + daemon bootstrap, both @allow-throw entry points).
