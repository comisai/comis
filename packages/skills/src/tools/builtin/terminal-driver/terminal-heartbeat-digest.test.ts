...
/**
 * Unit tests for the pure heartbeat line
 * (terminal-heartbeat-digest.ts).
 *
 * `heartbeatLine(j)` assembles the content-free heartbeat one-liner PURELY from the
 ...
 *   - content-free: the ONLY screen-derived text in the output is the passed
...
describe("heartbeatLine — content-free: the ONLY screen text is the passed digest, verbatim", () => {
