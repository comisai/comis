...
// @allow-throw: Canary encrypt / decrypt assertion: master-key mismatch must surface as a hard failure (not a Result.err that the caller might silently swallow). Encryption-correctness boundary per AGENTS.md §2.1 (security-critical assertion zone analog) (Phase 41 TS-HYG-07).
/**
