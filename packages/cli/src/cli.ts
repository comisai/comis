...
import { registerManagedRunCommands } from "./commands/managed-runs.js";
...
import { registerQuarantineCommand } from "./commands/quarantine.js";
import { registerCronCommand } from "./commands/cron.js";
import { registerTasksCommand } from "./commands/tasks.js";
import { registerSystemHealthCommand } from "./commands/system-health.js";
...
registerManagedRunCommands(program);
registerOrchestrateCommand(program);
registerWhoamiCommand(program);
registerCostExportCommand(program);
registerQuarantineCommand(program);
