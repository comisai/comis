...
// @allow-throw: pi-ai StreamFn boundary — re-throws synchronous next() exception (contract violation) after recording model:after audit trail; the executor catches the throw at the streamFunction invocation site.
/**
