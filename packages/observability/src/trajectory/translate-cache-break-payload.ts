 ...
 * (PERSIST-01, Phase 176 Plan 04 + AUDIT-05 Plan 05). Extracted from
 ...
 *
 * CONTENT-FREE (the load-bearing constraint, §2.7 / I3 / H1): a closed `reason`,
 ...
 * formula as the Plan-04 `obs_diagnostics` row-builder:
