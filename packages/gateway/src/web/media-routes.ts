...
// @allow-throw: @allow-throw boundary: gateway HTTP media-routes; throws caught by Hono framework error-handler boundary per AGENTS.md §2.1 web exception (Phase 41 TS-HYG-07).
/**
