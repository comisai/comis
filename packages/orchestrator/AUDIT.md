...
| activityStreamPort | optional | absent → the inbound pipeline activity gate (execution-pipeline.ts:395) is false; no per-turn coordinator is built and renderer.apply never fires (fail-closed §22.2 Day-0) | packages/orchestrator/src/channel-manager.ts:192 |
