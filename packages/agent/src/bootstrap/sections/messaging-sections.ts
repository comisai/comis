...
export function buildMessagingSection(
  ...
  return [
    ...
    "- Do NOT narrate intent before calling a tool. Avoid prefacing tool calls with phrases like \"I'll do X now…\" or \"Let me run Y…\" — invoke the tool directly. Phase-7 RC-9: pre-tool-text creates user-visible promises the agent may not be able to fulfill if the tool gets backgrounded.",
