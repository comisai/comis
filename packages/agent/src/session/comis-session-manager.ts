...
export interface SessionMetadata {
  ...
  sessionEnd?: {
    type: "session_end";
    timestamp: string;
    endReason: "success" | "error" | "timeout" | "budget_exceeded" | "budget_exhausted" | "circuit_open" | "provider_degraded" | "completed_with_tool_errors" | "context_exhausted" | "output_starved" | "narration_stall" | "tool_invocation_stall" | "spend_exceeded" | "background_pending" | "cancelled";
    durationMs: number;
    totalTokens: number;
