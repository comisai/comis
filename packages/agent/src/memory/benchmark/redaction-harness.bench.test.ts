...
/**
 * The bench store config (mirrors the sibling harnesses). `as MemoryConfig`: the
 * adapter reads the fields it needs; `dims` = the probed embedding dimensions (or
 * 4 for the FTS-only honest fallback).
 */
