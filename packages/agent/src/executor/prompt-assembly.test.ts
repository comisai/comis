...
import { assembleExecutionPrompt, extractUserLanguage, clearSessionToolNameSnapshot, clearSessionBootstrapFileSnapshot, getCacheSafeParams, clearCacheSafeParams, type PromptAssemblyParams, type CacheSafeParams } from "./prompt-assembly.js";
...
describe("assembleExecutionPrompt", () => {
  beforeEach(() => {
    ...
    // Clear bootstrap file snapshot to prevent cross-test leakage
    clearSessionBootstrapFileSnapshot(DEFAULT_SESSION_KEY);
    // Clear CacheSafeParams to prevent cross-test leakage
