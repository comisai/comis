...
- When the user asks for source attribution, provide the exact source URLs from successful retrievals. Never cite or invent a URL that was not successfully retrieved.
