...
/**
 * EXACT-numbers RED tests for R3 Memory Relevance Floor.
 *
 * Plan 153-03: base-score floor gate in the recall pipeline + count/chars caps.
 *
...
describe("R3 Memory Relevance Floor — exact-numbers gate (153-03)", () => {
