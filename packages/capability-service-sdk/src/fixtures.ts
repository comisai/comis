...
export const ProtocolFixtureTargetSchema = z.enum([
  ...
  "cancel-response",
  "error-response",
  "group-abandon-response",
  "group-activate-response",
  "group-get-host-rollup-response",
  "handshake-response",
  "health-response",
  "heartbeat-response",
  "consume-approval-response",
...
export const PROTOCOL_FIXTURE_SCENARIOS = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        expectation: "accept",
        schemaExpectation: "accept",
        payload: request("operation_group_activate", "managedRunGroups.activate", {
      ...
      {
        target: "group-activate-response",
        expectation: "accept",
        schemaExpectation: "accept",
        payload: {
          jsonrpc: "2.0",
      ...
      },
      {
        ...
        expectation: "accept",
        schemaExpectation: "accept",
        payload: request("operation_group_rollup", "managedRunGroups.getHostRollup", {
          operationId: "operation_group_rollup",
          managedRunGroupId: "managed-run-group_a",
        }),
      },
      {
        target: "group-get-host-rollup-response",
        expectation: "accept",
        schemaExpectation: "accept",
        payload: {
          jsonrpc: "2.0",
      ...
      },
      {
        ...
        expectation: "accept",
        schemaExpectation: "accept",
        payload: request("operation_group_abandon", "managedRunGroups.abandon", {
      ...
      },
      {
        ...
        expectation: "accept",
        schemaExpectation: "accept",
        payload: request("consume-approval_a", "managedRuns.consumeApproval", {
          operationId: "consume-approval_a",
          managedRunId,
          approvalRequestId: "10000000-0000-4000-8000-000000000001",
          mcpOperationId: "operation_prepare",
        }),
      },
      {
        target: "consume-approval-response",
        expectation: "accept",
        schemaExpectation: "accept",
        payload: {
          jsonrpc: "2.0",
          ...
          result: {
            ...
            operationFingerprint: emptyDigest,
      ...
      },
      {
        ...
        expectation: "accept",
        schemaExpectation: "accept",
        payload: request("operation_cancel", "managedRuns.cancel", {
      ...
      },
      {
        ...
        expectation: "accept",
        schemaExpectation: "accept",
        payload: request("operation_heartbeat", "managedRuns.heartbeat", {
