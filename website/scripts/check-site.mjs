...
for (const requiredText of [
  ...
  "The default tool profile is full and an empty per-agent secret allowlist is unrestricted.",
  "The approvals schema defaults off; guided setup enables it when it creates an administrator mapping.",
