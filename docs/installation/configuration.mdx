...
| Multiple files | Comma-separated paths -- later files override earlier ones |
...
the default. You can point to multiple files:
...
<CardGroup cols={2}>
  ...
  <Card title="Config Reference" icon="book" href="/reference/config-yaml">
    Complete reference for all 34 configuration sections.
  </Card>
</CardGroup>
