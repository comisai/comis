...
<Steps>
  ...
  <Step title="Point at the Comis Docker Hub image">
    ...
    e.g. `docker.io/comisai/comis:1.0.52-slim`.
    </Tip>
...
services:
  - type: web
    ...
    runtime: image
    image:
      url: docker.io/comisai/comis:1.0.52-slim   # pin to an immutable tag
...
<Steps>
  ...
  <Step title="Update the image URL">
    ...
    `comisai/comis:1.0.52-slim` to the new version → **Save Changes**.
