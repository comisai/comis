...
[Observability → Recall events](/operations/observability#15-2-recall-events-direct-emit-not-bridge-mapped).
...
[recall-trace artifact](/operations/observability#15-1-the-recall-trace-artifact-opt-in),
never in `daemon.log`.
