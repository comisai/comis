...
This page documents the observability foundations. It covers the trajectory layer, the 55-entry bridge mapping, lifecycle envelopes, forensic INFO promotions, the dedup detector, boot invariants, the alert budget, `step:` discipline, log rotation, and the bundle export entry point. If you are new to Comis observability, start here; then follow the cross-links for operator workflows.
