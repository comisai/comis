...
The trajectory bus-bridge maps 66 event types from the typed event bus to trajectory events (up from 18 previously — a ~3.7× coverage improvement).
...
## 17. Existing Tracking Surfaces (pre-existing, preserved for completeness)
