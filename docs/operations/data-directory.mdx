...
```bash
COMIS_CONFIG_PATHS="/etc/comis/config.yaml:/home/me/.comis/config.yaml" node packages/daemon/dist/daemon-entrypoint.js
```
...
pm2 stop comis   # or an anchored daemon-entrypoint.js process match
