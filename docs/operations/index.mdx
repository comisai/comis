...
- **[systemd](/operations/systemd)** -- Running Comis as a Linux system service with automatic restarts and health checks.
- **[Docker](/operations/docker)** -- Container deployment with health checks and persistent volumes.
...
<CardGroup cols={3}>
  ...
  <Card title="Docker" icon="docker" href="/operations/docker">
    Container setup, health checks, and persistent data.
  </Card>
