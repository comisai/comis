...
<Steps>
  <Step title="Install and register signal-cli">
    ...
    Start the signal-cli REST API daemon:
...
Signal does **not** support editing messages, threads, fetching message history,
buttons, cards/embeds, or mentions.
...
<AccordionGroup>
  <Accordion title="Connection refused to localhost:8080">
    ...
    **How to fix it:** Start signal-cli with
    `signal-cli -u YOUR_NUMBER daemon --json-rpc` and verify it responds at
