...
- Send file attachments up to 16 MB

iMessage does **not** support reactions, editing or deleting sent messages,
threads, buttons, cards or embeds, streaming (live-updating responses),
