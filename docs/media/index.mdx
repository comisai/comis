...
| Google Chat | Yes | Yes | No | Yes | Yes | No |
...
rich messages with buttons currently render on Discord, Telegram, Slack,
Microsoft Teams (as Adaptive Cards), and Google Chat (as Cards v2); LINE and
WhatsApp button rendering is not yet wired through `sendMessage`, and Signal,
iMessage, IRC, and Email do not support buttons. See each
