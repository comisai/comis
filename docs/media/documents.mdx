...
content so your agent can read and understand it. This works automatically
for 14 supported file types, including scanned PDFs that need OCR. Your agent
can then answer questions about the document, summarize it, or use the
