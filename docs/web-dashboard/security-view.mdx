---
title: "Security"
description: "Manage security settings, audit logs, and approval gates from the dashboard"
icon: "shield-check"
---

The Security view is your command center for reviewing what your agents are doing and controlling what they are allowed to do. It combines two areas of the dashboard: the **Security** page (click **Security** in the sidebar) for configuration and audit logs, and the **Approvals** page (click **Approvals** in the sidebar) for reviewing and acting on pending permission requests.
