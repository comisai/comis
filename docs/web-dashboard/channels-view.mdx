...
**Who it's for:** operators triaging a "why isn't Discord answering?" question, and anyone rotating credentials.
...
See the [Channels overview](/channels/index) for the full list of nine adapters (Telegram, Discord, Slack, WhatsApp, Signal, iMessage, LINE, IRC, Email).
