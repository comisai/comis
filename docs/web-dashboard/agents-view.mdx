---
title: "Agents View"
description: "View and manage your AI agents from the web dashboard"
icon: "robot"
---
...
The main view is a sortable data grid showing every configured agent. Click any column header to sort by that column. The columns are:

| Column | What It Shows |
|--------|--------------|
| **ID** | The unique identifier for the agent |
| **Name** | The display name you gave the agent |
| **Model** | The AI model the agent uses (such as Claude or GPT) |
| **Status** | Current state, shown as a colored tag |
| **Actions** | Buttons for Configure, Suspend/Resume, and Delete |
