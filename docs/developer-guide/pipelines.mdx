...
const node: GraphNode = {
  ...
  retries: 1,                         // Retry count 0-3 (default: 0)
  contextMode: "full",                // "full" | "summary" | "none" (default: "full")
};
...
|---------|------|-------|---------|
| `retries` | integer | 0-3 | 0 (no retries) |
...
<Info>
These limits are configurable via YAML config under `agentToAgent.graphMaxConcurrency`, `agentToAgent.graphMaxParallelSpawns`, and `agentToAgent.graphMaxGlobalSubAgents`.
</Info>
