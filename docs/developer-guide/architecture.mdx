...
All 15 packages adhere to this pattern. The dependency direction is always inward -- adapters depend on ports, never on each other.
...
graph TD
    ...
    observability["@comis/observability<br/>Diagnostics, cache-trace, EventBus bridge"]
    orchestrator["@comis/orchestrator<br/>Inbound pipeline, channel-manager, routing"]
