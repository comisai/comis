...
| channels | `@comis/channels` | 12 platform adapters (Discord, Telegram, Slack, WhatsApp, Signal, iMessage, LINE, IRC, Echo, Email, Microsoft Teams, Matrix) | Channel adapters, message mappers, media resolvers |
...
- **12 channel adapters** connecting to real-world chat platforms
