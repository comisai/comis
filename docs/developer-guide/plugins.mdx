...
The hook system is the primary extension mechanism for customizing Comis behavior. All 13 hooks are organized into six domains: Agent, Tool, Compaction, Delivery, Session, and Gateway.
