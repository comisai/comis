...
comis capability-services get dev-crew-local

# What external work exists, across every conversation this daemon holds?
comis managed-runs list
comis managed-runs list --service dev-crew-local --state unknown --limit 50
...
Lists, explains, and cancels the external work bound to this daemon. See
...
routed to. See [`comis capability-services`](#comis-capability-services) above.
