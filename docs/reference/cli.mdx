...
| `--matrix-homeserver <url>` | `string` | - | Matrix homeserver base URL |
| `--matrix-user-id <id>` | `string` | - | Matrix bot user ID (MXID, `@bot:host`) |
| `--matrix-access-token <tok>` | `string` | - | Matrix bot access token |
| `--matrix-e2ee <value>` | `true` \| `false` | `true` | Enable Matrix end-to-end encryption |
