...
comis sessions reset "default:agent:default:user123:telegram" --yes

# Also clear RAG memories for this session (the full-forget path — prints deleted count)
comis sessions reset "default:agent:default:user123:telegram" --memory --yes

# Nuclear forget — also purge consolidated observations derived from this session
comis sessions reset "default:agent:default:user123:telegram" --memory --purge-derived --yes
```
...
comis explain "root-session-default:agent:default:user123:telegram"
