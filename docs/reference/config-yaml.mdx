...
| `aggregateBudgetUsd` | `number` | `2.0` | Hard $ ceiling across the whole spawn tree, per root run. |
| `maxConcurrentSelfAgents` | `number` | `4` | Tree-wide concurrent self-spawned-agent ceiling. |
