...
| `promoteAtProofCount` | `number` (positive int) | `3` | The verified-success count at which an admitted `candidate` procedure promotes to `active`. The promotion driver itself is a later phase (P3); this is the threshold it will read |
