...
In the common `auto` case Comis 183 currently wires the built-in **OpenRouter** image path (`provider: openrouter` + `OPENROUTER_API_KEY`); native Codex / OpenAI / Google image paths arrive in later phases.
