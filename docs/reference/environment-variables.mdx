...
| **Default** | Auto-generated with encrypted storage and written to `~/.comis/.env` (mode 0600) |

The canary seed makes outbound exfiltration markers unpredictable. When an
external secret manager supplies `CANARY_SECRET`, Comis uses that value and does
not duplicate it under the data directory.
