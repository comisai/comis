...
`requestRelevanceHistory` records `{ turnCount, charCount, saturated }` for the
bounded prior-user-turn window; and `operatorPolicyToolProjections` records up
