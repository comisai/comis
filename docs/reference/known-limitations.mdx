...
Comis is an enterprise-oriented open-source foundation under active
development. This page summarizes limits that matter when deciding what
authority to grant and where to deploy it.
