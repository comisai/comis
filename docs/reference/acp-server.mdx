...
**What this is for:** let an ACP-compatible editor (Claude Code, Cursor, Zed, custom VS Code extensions) talk to your Comis agents directly. **Who it's for:** developers integrating Comis into their IDE workflow.
...
<Steps>
  <Step title="Build an ACP entrypoint">
  ...
  <Step title="Configure the editor">
  ...
  <Step title="Verify it's wired up">
