...
ACP uses `@agentclientprotocol/sdk` 0.22.1. The SDK handles framing, buffering, and partial-read recovery — you do not implement the wire format yourself. Messages are structured JSON objects carried over the ndjson stream.
