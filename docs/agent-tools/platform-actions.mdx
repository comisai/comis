...
| Platform | Tool Name | Guide |
|----------|-----------|-------|
| Discord | `discord_action` | [Discord Actions](#discord-actions) |
| Telegram | `telegram_action` | [Telegram Actions](#telegram-actions) |
| Slack | `slack_action` | [Slack Actions](#slack-actions) |
| WhatsApp | `whatsapp_action` | [WhatsApp Actions](#whatsapp-actions) |
