...
| `ctx_expand` | Expand context entries (pipeline mode). In DAG mode, use `context_tool` instead. | [Context Management](/context-management) |
| `ctx_inspect` | Inspect individual context entries (pipeline mode). In DAG mode, use `context_tool` instead. | [Context Management](/context-management) |
| `ctx_recall` | Recall context by semantic query (pipeline mode). In DAG mode, use `context_tool` instead. | [Context Management](/context-management) |
| `ctx_search` | Search context by keyword (pipeline mode). In DAG mode, use `context_tool` instead. | [Context Management](/context-management) |
