...
Comis agents have access to a broad set of tools spanning file operations, web access, messaging, scheduling, media processing, browser automation, context management, and administration. This page is the master reference -- every tool listed with its category, description, and link to detailed documentation.
...
| **Platform tools** | Many | Comis-specific capabilities -- messaging, scheduling, sessions, media, infrastructure, and moderation. Documented on this tab. |
...
| `browser` | Headless browser automation | [Browser](/agent-tools/browser) |
...
| `pipeline` | Execute multi-step DAG workflows | [Sessions](/agent-tools/sessions) |
...
| Tool | Description | Guide |
|------|-------------|-------|
| `memory_tool` | Unified memory management: get (read by path), search (semantic search), store (persist with secret detection), manage (admin CRUD) | [Sessions](/agent-tools/sessions) |
...
| Tool | Description | Guide |
|------|-------------|-------|
| `gateway` | Configuration management and gateway control | [Infrastructure](/agent-tools/infrastructure) |
...
| Tool | Actions | Guide |
|------|---------|-------|
| `discord_action` | Server moderation actions (kick, ban, roles, threads, channels, and more) | [Platform Actions](/agent-tools/platform-actions) |
| `telegram_action` | Group and channel actions (pin, poll, sticker, ban, promote, and more) | [Platform Actions](/agent-tools/platform-actions) |
| `slack_action` | Workspace actions (pin, topic, archive, channels, invites, and more) | [Platform Actions](/agent-tools/platform-actions) |
| `whatsapp_action` | Group actions (group management, participants, settings, and more) | [Platform Actions](/agent-tools/platform-actions) |
