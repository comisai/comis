...
| Tool | Description | Guide |
|------|-------------|-------|
| `session_tool` | Unified session management (search, status, history, list -- 4 actions) | [Sessions](/agent-tools/sessions) |
...
| Tool | Description | Guide |
|------|-------------|-------|
| `memory_tool` | Unified memory management with 4 actions: get (read by path), search (semantic search), store (persist with secret detection), manage (admin CRUD) | [Sessions](/agent-tools/sessions) |
...
| Tool | Description | Guide |
|------|-------------|-------|
| `gateway` | Configuration management and gateway control (11 actions) | [Infrastructure](/agent-tools/infrastructure) |
...
| Remember something for later | `memory_tool` (action: `store`) | [Sessions](/agent-tools/sessions) |
