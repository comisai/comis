...
belonged to the DAG context engine, which is being reimplemented for the v2.12
"Lossless Context DAG" release; those tools were removed pending the
reimplementation and return with the LCD engine. See
