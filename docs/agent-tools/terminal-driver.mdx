...
- Before every authority-backed launch, the daemon rejects symlinked or escaped lease-private Git administration paths. It durably reserves the terminal identity before spawning, and failed launches confirm termination and retire that binding before the workspace can be released.
