...
The audit examines file permissions, secret storage, gateway settings, audit
logging, and more across 13 check categories -- then tells you exactly what to
fix and how to fix it. See [Hardening](/security/hardening) for the full
