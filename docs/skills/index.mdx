...
<Info>
The [Agent Tools](/agent-tools/index) page owns the complete tool inventory and
its per-category counts. See [Built-in Tools](/skills/built-in-tools) and
[Platform Tools](/skills/platform-tools) for the two layers and their detailed
contracts.
</Info>
