...
| Legacy top-level `allowedTools` (array) | `allowed-tools` (space-separated string) | The pre-migration camelCase tool restriction normalizes onto its spec-pure home |
