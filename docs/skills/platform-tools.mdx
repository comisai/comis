...
| Infrastructure | `gateway` | Read and modify configuration, manage the gateway | [Infrastructure Guide](/agent-tools/infrastructure) |
...
| Fleet Management | `agents_manage`, `obs_query`, `sessions_manage`, `memory_manage`, `channels_manage`, `tokens_manage`, `models_manage`, `skills_manage`, `mcp_manage` | Supervisor-level administration tools | [Infrastructure Guide](/agent-tools/infrastructure) |
...
- `agents_manage` -- create, update, and delete agent configurations (create/delete take effect immediately without daemon restart; update requires restart)
- `obs_query` -- query observability data (logs, metrics, traces)
