...
| Fleet Management | `agents_manage`, `obs_query`, `sessions_manage`, `memory_manage`, `channels_manage`, `tokens_manage`, `models_manage`, `skills_manage`, `mcp_manage`, `heartbeat_manage` | Supervisor-level administration tools | [Infrastructure Guide](/agent-tools/infrastructure) |
