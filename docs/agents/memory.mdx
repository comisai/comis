...
validation. A correction signal also does not guarantee demotion or durable
behavior change. It must be enabled, attributed to a surfaced skill, clear the
confidence and corroboration gates, and produce a weakening trend before the
state changes.
