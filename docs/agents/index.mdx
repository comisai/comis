...
<CardGroup cols={2}>
  ...
  <Card title="Models" icon="microchip" href="/agents/models">
    Choose from 11 AI providers including Anthropic, OpenAI, and Google.
    Switch models per agent, set up automatic failover, and rotate API keys.
  </Card>
</CardGroup>
...
There are 16 commands in total. See the full list on the
[Slash Commands](/agents/slash-commands) page.
