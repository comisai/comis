...
<CardGroup cols={2}>
  ...
  <Card title="Models" icon="microchip" href="/agents/models">
    Choose from 13 AI providers including Anthropic, OpenAI, Google, Mistral,
    Groq, xAI, Cerebras, OpenRouter, and more. Switch models per agent, set
    up automatic failover, and rotate API keys.
  </Card>
</CardGroup>
