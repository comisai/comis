...
- [Agents](https://docs.comis.ai/agents) | Type: Conceptual | Summary: What agents are and how they work inside Comis | Prerequisites: How It Works | Topics: agents, ai agents, core concepts
    ...
    - [Context Management](https://docs.comis.ai/context-management) | Type: Conceptual | Summary: Plain-language overview of the 10-layer context engine pipeline that keeps conversations in budget | Prerequisites: Sessions | Topics: context engine, layers, observation masking, dead content evictor
