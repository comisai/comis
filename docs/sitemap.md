...
- [Install on Linux](https://docs.comis.ai/installation/install-linux) — Step-by-step installation guide for Ubuntu, Fedora, and Arch Linux
- [Install on a VPS](https://docs.comis.ai/installation/install-vps) — Deploy Comis as a systemd service on a supported Ubuntu VPS
...
- [Setup Wizard](https://docs.comis.ai/web-dashboard/setup-wizard) — Re-run the guided onboarding flow from inside the dashboard
