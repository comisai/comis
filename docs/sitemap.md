...
- [Agents](https://docs.comis.ai/agents) | Type: Conceptual | Summary: What agents are and how they work inside Comis | Prerequisites: How It Works | Topics: agents, ai agents, core concepts
    ...
    - [Context Management](https://docs.comis.ai/agents/context-management) | Type: Conceptual | Summary: Plain-language overview of the 10-layer context engine pipeline that keeps conversations in budget | Prerequisites: Sessions | Topics: context engine, layers, observation masking, dead content evictor
...
- [Operations](https://docs.comis.ai/operations) | Type: Conceptual | Summary: Running, monitoring, and maintaining your Comis installation | Prerequisites: Installation | Topics: operations, management, production
    ...
    - [Docker Hub](https://docs.comis.ai/operations/docker-hub) | Type: How-to | Summary: Pulling and publishing official Comis images on Docker Hub | Prerequisites: Docker | Topics: docker, docker hub, registry, images
...
- [Developer Guide](https://docs.comis.ai/developer-guide) | Type: Conceptual | Summary: Extend Comis with custom adapters, plugins, skills, and execution pipelines | Prerequisites: How It Works | Topics: developer guide, extending, customization
    ...
    - [Packages](https://docs.comis.ai/developer-guide/packages) | Type: Reference | Summary: All 15 packages with roles, key exports, and dependency relationships | Prerequisites: Developer Guide | Topics: packages, monorepo, dependencies
    - [Event Bus](https://docs.comis.ai/developer-guide/event-bus) | Type: Reference | Summary: 183 typed events across 5 domain subsystems for cross-module communication | Prerequisites: Architecture | Topics: event bus, typed events, pub/sub
    - [Delivery Pipeline](https://docs.comis.ai/developer-guide/architecture/delivery-pipeline) | Type: Conceptual | Summary: How outbound messages flow from agent response through crash-safe persistence to channel delivery | Prerequisites: Architecture | Topics: delivery pipeline, queue, retry, crash recovery
    ...
    - [Plugins](https://docs.comis.ai/developer-guide/plugins) | Type: Reference | Summary: 13 lifecycle hooks (5 modifying, 8 void) and 4 extension registrations for customizing Comis behavior | Prerequisites: Developer Guide | Topics: plugins, hooks, extensions, lifecycle
...
- [Delivery Queue](https://docs.comis.ai/reference/configuration/delivery-queue) | Type: Reference | Summary: Crash-safe outbound message persistence, recovery, and delivery queue configuration reference | Prerequisites: Configuration Guide | Topics: delivery queue, crash recovery, persistence, retry
