...
- [ ] **Phase 4: Finalizer Interface** - Body-aware finalizer stage; AWS SigV4 as tested no-op (design P3)
...
- [ ] 04-01-PLAN.md — broker:denied reason union extension (body_too_large) in events-infra.ts
- [ ] 04-02-PLAN.md — finalizer-stage.ts TDD: bufferBody, runFinalizer, runAwsSigV4Finalizer (RED/GREEN unit tests)

**Wave 2** *(blocked on Wave 1 completion)*
- [ ] 04-03-PLAN.md — mitm-broker.ts Step 6.5 seam wiring + integration tests FINAL-01a/b/c/d
...
| 4. Finalizer Interface | 0/3 | Not started | - |
| 5. Forced Egress + Secure Credential Home | 0/TBD | Not started | - |
