...
- [ ] **Phase 2: Broker Core** - Single-use sessions, fail-closed request handling, injection wiring (design P1)
- [ ] **Phase 3: CA Manager** - Own CA, bounded leaf-cert cache, ALPN-pin to http/1.1 (design P2)
...
| 2. Broker Core | 0/4 | Not started | - |
| 3. CA Manager | 0/TBD | Not started | - |
| 4. Finalizer Interface | 0/TBD | Not started | - |
