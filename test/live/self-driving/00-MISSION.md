...
5. **Leave observability + the emulator better than you found them** — every diagnosis friction is itself an issue to close test-first (`03-OBSERVABILITY.md`).
