...
- **Evidence (ground truth):** `<trajectory / explain / system / daemon-log excerpt — the REAL payload, not a paraphrase>`
...
- **Observability gap closed:** `<the signal threaded to explain/system, proven on this incident — or N/A>`
