...
| `traceId` | `4f407b9f-8b53-4b07-bbf7-307ceb914554` | `fd945afe-14e9-43cd-8f3b-ad5ec0efe6d8` | `f1e2cbd7-92d5-48f2-a55b-fa69f70fc39e` | `94e80945-c13b-467b-b998-dde257502956` |
| `runId` | `69e70744-686f-47f8-886c-1bb0a64de44a` | `bdaaad72-01c4-4ee7-927f-226a1d8e4d8e` | `a0a7750c-765a-4bff-a62a-89255142d17b` | `a31fc23c-ed32-4259-80d7-687160c75636` |
...
pair identifies the recorded run and is regenerated by each rerun. Every figure comes from the runtime's own
durable output — the `_session-metadata.json` rollup this invocation wrote (selected against a pre-run
snapshot of every existing rollup's path and trace/run identity, so an earlier drive's session can never be
attributed to it, even on a reused data root), the trajectory resolved through
that rollup's co-located `.trajectory-path.json` pointer and filtered to its `traceId`, and `obs.explain`
over the gateway — never from the model reply.
