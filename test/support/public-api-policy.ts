...
export const PUBLIC_API_POLICY: ReadonlyMap<string, ReadonlySet<string>> =
  new Map<string, ReadonlySet<string>>([
    ...
    ["@comis/memory", new Set<string>([
      ...
      "CtxSummaryRow",
      "CtxContextItemRow",
      // Phase 41 Plan 01 (TS-HYG-01, TS-HYG-02) — generic RowMapper factory
      // + per-row Zod schemas. These are introduced by Plan 41-01 and
      // consumed by Plan 41-04 (SQLite call-site retargeting). No in-repo
      // consumer exists until 41-04 lands; tracked here as transient
      // orphans for the inter-plan gap. Removed wholesale when 41-04
      // imports them at the call sites it retargets.
