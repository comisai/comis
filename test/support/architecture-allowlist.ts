...
export const testNamingAllowlist: readonly TestNamingAllowlistEntry[] = [
  { file: "packages/agent/src/background/completion-formatter.test.ts", line: 27, kind: "it", text: "success header tag", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/agent/src/background/completion-formatter.test.ts", line: 33, kind: "it", text: "failure header tag", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/agent/src/bootstrap/section-extractor.test.ts", line: 276, kind: "it", text: "is exported as 3000", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/agent/src/bootstrap/system-prompt-assembler.test.ts", line: 189, kind: "it", text: "omits empty fields", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/agent/src/context-engine/constants.test.ts", line: 148, kind: "it", text: "equals 10", reason: "Plan-40-10 captured (min-length=9); shrink in follow-on plan" },
  { file: "packages/agent/src/envelope/message-envelope.test.ts", line: 49, kind: "it", text: "formats in 24h mode", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/agent/src/executor/active-run-registry.test.ts", line: 159, kind: "it", text: "starts at 0", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/agent/src/executor/overflow-recovery.test.ts", line: 285, kind: "it", text: "custom truncationTargetRatio config works", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/agent/src/executor/step-counter.test.ts", line: 6, kind: "it", text: "starts at count 0", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/agent/src/executor/tool-deferral.test.ts", line: 929, kind: "it", text: "has 5 rules", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/agent/src/model/auth-usage-tracker.test.ts", line: 110, kind: "it", text: "clears all stats", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/agent/src/provider/model-id-normalize.test.ts", line: 24, kind: "it", text: "is case insensitive", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/agent/src/response-filter/thinking-tag-filter.test.ts", line: 361, kind: "it", text: "handles empty delta", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/agent/src/safety/context-truncation-recovery.test.ts", line: 73, kind: "it", text: "is case-insensitive", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/agent/src/safety/response-safety-checks.test.ts", line: 107, kind: "it", text: "is case-insensitive", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/agent/src/safety/tool-output-safety.test.ts", line: 112, kind: "it", text: "is case insensitive", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/agent/src/safety/tool-output-safety.test.ts", line: 383, kind: "it", text: "strips BOM (U+FEFF)", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/agent/src/session/sanitize-session-secrets.test.ts", line: 499, kind: "it", text: "detects OpenAI keys", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/agent/src/session/sanitize-session-secrets.test.ts", line: 503, kind: "it", text: "detects Groq keys", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/agent/src/spawn/sub-agent-runner.test.ts", line: 3103, kind: "it", text: "equals 300000", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/agent/src/workspace/boot-file.test.ts", line: 6, kind: "it", text: "equals 'BOOT.md'", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/channels/src/discord/discord-adapter.test.ts", line: 225, kind: "it", text: "returns 'discord'", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/channels/src/discord/format-discord.test.ts", line: 138, kind: "it", text: "custom maxChars and maxLines options work", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/channels/src/echo/echo-adapter.test.ts", line: 272, kind: "it", text: "clears all state", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/channels/src/imessage/imessage-adapter.test.ts", line: 72, kind: "it", text: "stops gracefully", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/channels/src/irc/irc-adapter.test.ts", line: 117, kind: "it", text: "returns 'irc'", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/channels/src/line/line-adapter.test.ts", line: 185, kind: "it", text: "logs info on stop", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/emoji-tier-map.test.ts", line: 177, kind: "it", text: "is case-insensitive", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/lifecycle-state-machine.test.ts", line: 168, kind: "it", text: "allows done -> idle", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/poll-normalizer.test.ts", line: 61, kind: "it", text: "handles zero votes", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/poll-normalizer.test.ts", line: 211, kind: "it", text: "handles empty votes", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/prefix-template.test.ts", line: 76, kind: "it", text: "upper: uppercases", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/prefix-template.test.ts", line: 80, kind: "it", text: "lower: lowercases", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/regex-guard.test.ts", line: 44, kind: "it", text: "rejects (a+)+", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/regex-guard.test.ts", line: 50, kind: "it", text: "rejects (.*)*", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/regex-guard.test.ts", line: 56, kind: "it", text: "rejects (.+)+", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/regex-guard.test.ts", line: 61, kind: "it", text: "rejects (a*)*", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/regex-guard.test.ts", line: 66, kind: "it", text: "rejects (a+)*", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/channels/src/shared/regex-guard.test.ts", line: 71, kind: "it", text: "rejects (a*)+", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/channels/src/signal/signal-adapter.test.ts", line: 87, kind: "it", text: "stops successfully", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/channels/src/signal/signal-adapter.test.ts", line: 123, kind: "it", text: "sends to group", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/channels/src/signal/signal-adapter.test.ts", line: 315, kind: "it", text: "registers handler", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/channels/src/signal/signal-format.test.ts", line: 131, kind: "it", text: "handles empty IR", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/channels/src/slack/format-slack.test.ts", line: 7, kind: "it", text: "escapes & to &amp;", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/channels/src/slack/format-slack.test.ts", line: 11, kind: "it", text: "escapes < to &lt;", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/channels/src/slack/format-slack.test.ts", line: 15, kind: "it", text: "escapes > to &gt;", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/channels/src/slack/slack-adapter.test.ts", line: 157, kind: "it", text: "returns 'slack'", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/channels/src/slack/slack-adapter.test.ts", line: 275, kind: "it", text: "calls app.start()", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/channels/src/slack/slack-adapter.test.ts", line: 598, kind: "it", text: "calls app.stop()", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/channels/src/telegram/telegram-adapter.test.ts", line: 328, kind: "it", text: "returns 'telegram'", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/channels/src/whatsapp/whatsapp-adapter.test.ts", line: 137, kind: "it", text: "returns 'whatsapp'", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/cli/src/mock-rpc-client.test.ts", line: 116, kind: "it", text: "does not throw", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/cli/src/output/format.test.ts", line: 107, kind: "it", text: "json() handles null", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/cli/src/output/spinner.test.ts", line: 46, kind: "it", text: "rethrows on failure", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/cli/src/output/spinner.test.ts", line: 56, kind: "it", text: "passes text to ora", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/cli/src/output/spinner.test.ts", line: 61, kind: "it", text: "calls start()", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/cli/src/tooling-fill/orchestrator.test.ts", line: 643, kind: "it", text: "stopDaemon < writeBackup < atomicWriteFile < startDaemon (happy path)", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  ...
  { file: "packages/cli/src/util/daemon-required.test.ts", line: 57, kind: "it", text: "DAEMON_PROBE_TIMEOUT_MS === 200 (MEM-CTX-PORTS-12 contract)", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/cli/src/util/exit-codes.test.ts", line: 6, kind: "it", text: "ExitCode.DaemonRequired === 4", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/non-interactive.test.ts", line: 760, kind: "it", text: "has correct message", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/state.test.ts", line: 62, kind: "it", text: "remote has 7 steps", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/agent-name.test.ts", line: 82, kind: "it", text: "rejects underscores", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/agent-name.test.ts", line: 88, kind: "it", text: "rejects dots", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/api-key.test.ts", line: 217, kind: "it", text: "is case insensitive", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/channel-creds.test.ts", line: 206, kind: "it", text: "returns [] for irc", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/channel-creds.test.ts", line: 214, kind: "it", text: "is case insensitive", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 7, kind: "it", text: "accepts 192.168.1.1", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 11, kind: "it", text: "accepts 0.0.0.0", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 19, kind: "it", text: "accepts 127.0.0.1", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 25, kind: "it", text: "rejects octet > 255", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 37, kind: "it", text: "rejects non-numeric", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 59, kind: "it", text: "accepts loopback", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 63, kind: "it", text: "accepts lan", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 67, kind: "it", text: "accepts custom", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 73, kind: "it", text: "rejects 'public'", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/network.test.ts", line: 79, kind: "it", text: "rejects 'external'", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/port.test.ts", line: 25, kind: "it", text: "rejects 1023", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/port.test.ts", line: 31, kind: "it", text: "rejects 0", reason: "Plan-40-10 captured (min-length=9); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/port.test.ts", line: 45, kind: "it", text: "rejects 65536", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/port.test.ts", line: 51, kind: "it", text: "rejects 99999", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/port.test.ts", line: 59, kind: "it", text: "rejects 'abc'", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/port.test.ts", line: 65, kind: "it", text: "rejects 'NaN'", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/cli/src/wizard/validators/port.test.ts", line: 73, kind: "it", text: "rejects 4766.5", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  ...
  { file: "packages/core/src/config/section-registry-parity.test.ts", line: 51, kind: "it", text: "getConfigSections()", reason: "Plan-40-10 captured (min-length=19; use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/core/src/config/section-registry-parity.test.ts", line: 111, kind: "it", text: "MANAGED_SECTIONS — 5-entry array", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  ...
  { file: "packages/core/src/hooks/integration.test.ts", line: 164, kind: "it", text: "plugin error isolation", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  ...
  { file: "packages/core/src/ports/tool-capability.test.ts", line: 27, kind: "it", text: "declares all 9 methods (7 config-view + 2 runtime-view)", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  ...
  { file: "packages/daemon/src/api/context-handlers.test.ts", line: 161, kind: "it", text: "limit is respected", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/daemon/src/api/env-handlers.test.ts", line: 117, kind: "it", text: "rejects empty key", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/daemon/src/api/env-handlers.test.ts", line: 144, kind: "it", text: "rejects missing key", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/daemon/src/api/env-handlers.test.ts", line: 157, kind: "it", text: "rejects empty value", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/daemon/src/api/secrets-handlers.test.ts", line: 203, kind: "it", text: "rejects empty value", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/daemon/src/api/workspace-handlers.test.ts", line: 1057, kind: "it", text: "parses added files", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/daemon/src/device/device-identity.test.ts", line: 102, kind: "it", text: "round-trip succeeds", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/daemon/src/graph/drivers/agent-driver.test.ts", line: 34, kind: "it", text: "has typeId 'agent'", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/daemon/src/graph/drivers/agent-driver.test.ts", line: 109, kind: "it", text: "returns 90_000", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/daemon/src/graph/drivers/debate-driver.test.ts", line: 34, kind: "it", text: "has typeId 'debate'", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/daemon/src/graph/drivers/refine-driver.test.ts", line: 34, kind: "it", text: "has typeId 'refine'", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/daemon/src/graph/drivers/vote-driver.test.ts", line: 35, kind: "it", text: "has typeId 'vote'", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/daemon/src/observability/log-infra.test.ts", line: 54, kind: "it", text: "setLevel(\"agent\", \"debug\") changes that logger\\'s level", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/gateway/src/openai/openai-types.test.ts", line: 154, kind: "it", text: "maps stop to stop", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/gateway/src/openai/openai-types.test.ts", line: 170, kind: "it", text: "maps error to stop", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/gateway/src/responses/responses-types.test.ts", line: 37, kind: "it", text: "accepts stream:true", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/gateway/src/responses/responses-types.test.ts", line: 124, kind: "it", text: "starts at 0", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/gateway/src/rpc/ws-handler.test.ts", line: 39, kind: "it", text: "adds a connection", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/gateway/src/rpc/ws-handler.test.ts", line: 403, kind: "it", text: "onError logs error", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/gateway/src/web/rest-api.test.ts", line: 487, kind: "it", text: "clears all entries", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/gateway/src/webhook/webhook-mapping.test.ts", line: 30, kind: "it", text: "lowercases the path", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/gateway/src/webhook/webhook-mapping.test.ts", line: 65, kind: "it", text: "resolves path", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/gateway/src/webhook/webhook-mapping.test.ts", line: 69, kind: "it", text: "resolves now", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/gateway/src/webhook/webhook-mapping.test.ts", line: 77, kind: "it", text: "resolves header", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/gateway/src/webhook/webhook-mapping.test.ts", line: 134, kind: "it", text: "resolves {{now}}", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/gateway/src/webhook/webhook-mapping.test.ts", line: 140, kind: "it", text: "resolves {{path}}", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/gateway/src/webhook/webhook-mapping.test.ts", line: 192, kind: "it", text: "matches by path", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/memory/src/hybrid-search.test.ts", line: 466, kind: "it", text: "filters by tenantId", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/memory/src/memory-api.test.ts", line: 167, kind: "it", text: "filters by tags", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/memory/src/memory-api.test.ts", line: 196, kind: "it", text: "filters by tenantId", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/memory/src/memory-api.test.ts", line: 307, kind: "it", text: "clears by olderThan", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/memory/src/named-graph-store.test.ts", line: 118, kind: "it", text: "respects offset", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/memory/src/session-store.test.ts", line: 335, kind: "it", text: "filters by tenantId", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/memory/src/sqlite-memory-adapter.test.ts", line: 266, kind: "it", text: "scopes by tenantId", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/memory/src/sqlite-memory-adapter.test.ts", line: 349, kind: "it", text: "filters by tags", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/memory/src/sqlite-memory-adapter.test.ts", line: 443, kind: "it", text: "updates tags", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/memory/src/sqlite-memory-adapter.test.ts", line: 457, kind: "it", text: "updates trustLevel", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/memory/src/sqlite-memory-adapter.test.ts", line: 469, kind: "it", text: "updates expiresAt", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/memory/src/sqlite-memory-adapter.test.ts", line: 552, kind: "it", text: "scopes by tenantId", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/memory/src/sqlite-secret-store.test.ts", line: 274, kind: "it", text: "does not throw", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/scheduler/src/cron/cron-scheduler.test.ts", line: 102, kind: "it", text: "stop() clears timer", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/scheduler/src/cron/cron-types.test.ts", line: 114, kind: "it", text: "accepts main", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/scheduler/src/cron/cron-types.test.ts", line: 118, kind: "it", text: "accepts isolated", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/scheduler/src/cron/cron-types.test.ts", line: 310, kind: "it", text: "accepts fresh", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/scheduler/src/cron/cron-types.test.ts", line: 314, kind: "it", text: "accepts rolling", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/scheduler/src/cron/cron-types.test.ts", line: 318, kind: "it", text: "accepts accumulate", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/scheduler/src/heartbeat/quiet-hours.test.ts", line: 11, kind: "it", text: "parses 07:00 -> 420", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/scheduler/src/heartbeat/quiet-hours.test.ts", line: 15, kind: "it", text: "parses 00:00 -> 0", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/scheduler/src/heartbeat/quiet-hours.test.ts", line: 23, kind: "it", text: "parses 12:30 -> 750", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/scheduler/src/heartbeat/response-cache.test.ts", line: 15, kind: "it", text: "is deterministic", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/scheduler/src/heartbeat/response-cache.test.ts", line: 55, kind: "it", text: "clears all entries", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/scheduler/src/heartbeat/response-processor.test.ts", line: 17, kind: "it", text: "strips HTML tags", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/scheduler/src/heartbeat/response-processor.test.ts", line: 49, kind: "it", text: "trims whitespace", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/scheduler/src/heartbeat/response-processor.test.ts", line: 67, kind: "it", text: "detects exact token", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/scheduler/src/heartbeat/response-processor.test.ts", line: 144, kind: "it", text: "is case-sensitive", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/scheduler/src/tasks/task-priority.test.ts", line: 47, kind: "it", text: "overdue task -> urgencyScore=100", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/scheduler/src/tasks/task-priority.test.ts", line: 53, kind: "it", text: "due in 1 day -> urgencyScore=90", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/scheduler/src/tasks/task-priority.test.ts", line: 60, kind: "it", text: "due in 2 days -> urgencyScore=70", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/scheduler/src/tasks/task-priority.test.ts", line: 66, kind: "it", text: "due in 5 days -> urgencyScore=50", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/scheduler/src/tasks/task-priority.test.ts", line: 72, kind: "it", text: "due in 15 days -> urgencyScore=30", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/scheduler/src/tasks/task-priority.test.ts", line: 78, kind: "it", text: "due in 60 days -> urgencyScore=10", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/scheduler/src/tasks/task-priority.test.ts", line: 158, kind: "it", text: "handles single task", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/shared/src/timeout.test.ts", line: 19, kind: "it", text: "is instanceof Error", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  ...
  { file: "packages/skills/src/tools/browser/profiles.test.ts", line: 13, kind: "it", text: "has 10 entries", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  ...
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 93, kind: "it", text: "blocks BOM (U+FEFF)", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 104, kind: "it", text: "allows plain ASCII", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 120, kind: "it", text: "allows empty string", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 165, kind: "it", text: "safe env passes", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 299, kind: "it", text: "allows escaped $", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 325, kind: "it", text: "splits on &&", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 329, kind: "it", text: "splits on ||", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 333, kind: "it", text: "splits on ;", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 337, kind: "it", text: "splits on |", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 341, kind: "it", text: "splits on &", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 370, kind: "it", text: "blocks pipe to nc", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 374, kind: "it", text: "blocks pipe to curl", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 382, kind: "it", text: "blocks pipe to bash", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 386, kind: "it", text: "blocks pipe to sh", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 403, kind: "it", text: "allows pipe to grep", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 407, kind: "it", text: "allows pipe to wc", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 475, kind: "it", text: "blocks find -exec", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 548, kind: "it", text: "allows plain echo", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 803, kind: "it", text: "allows NODE_ENV", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 807, kind: "it", text: "allows locale vars", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 811, kind: "it", text: "allows FORCE_COLOR", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 815, kind: "it", text: "allows LC_ALL", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 819, kind: "it", text: "allows HOME", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 828, kind: "it", text: "blocks LD_PRELOAD", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 840, kind: "it", text: "blocks PERL5OPT", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 846, kind: "it", text: "blocks GIT_ASKPASS", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 852, kind: "it", text: "blocks NODE_OPTIONS", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 858, kind: "it", text: "blocks EDITOR", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1351, kind: "it", text: "allows $PATH", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1355, kind: "it", text: "allows $HOME", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1366, kind: "it", text: "blocks zmodload", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1370, kind: "it", text: "blocks emulate", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1374, kind: "it", text: "blocks zpty", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1378, kind: "it", text: "blocks ztcp", reason: "Plan-40-10 captured (min-length=11); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1382, kind: "it", text: "blocks zsocket", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1386, kind: "it", text: "blocks zf_rm", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1398, kind: "it", text: "blocks fc -e", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1439, kind: "it", text: "allows quoted JSON", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/builtin/exec-security.test.ts", line: 1530, kind: "it", text: "allows quoted hash", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  ...
  { file: "packages/skills/src/tools/integrations/document/xml-block.test.ts", line: 10, kind: "it", text: "escapes & to &amp;", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/document/xml-block.test.ts", line: 14, kind: "it", text: "escapes < to &lt;", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/document/xml-block.test.ts", line: 18, kind: "it", text: "escapes > to &gt;", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/document/xml-block.test.ts", line: 26, kind: "it", text: "escapes ' to &apos;", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  ...
  { file: "packages/skills/src/tools/integrations/link/link-detector.test.ts", line: 14, kind: "it", text: "extracts bare URLs", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/link/link-detector.test.ts", line: 32, kind: "it", text: "deduplicates URLs", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/link/link-detector.test.ts", line: 40, kind: "it", text: "respects maxLinks", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/link/link-detector.test.ts", line: 78, kind: "it", text: "skips invalid URLs", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/tts/tts-output-format.test.ts", line: 89, kind: "it", text: "\".opus\" -> \"audio/opus\"", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/tts/tts-output-format.test.ts", line: 93, kind: "it", text: "\".ogg\" -> \"audio/opus\"", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/tts/tts-output-format.test.ts", line: 97, kind: "it", text: "\".mp3\" -> \"audio/mpeg\"", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/tts/tts-output-format.test.ts", line: 101, kind: "it", text: "\".wav\" -> \"audio/wav\"", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/tts/tts-output-format.test.ts", line: 105, kind: "it", text: "\".aac\" -> \"audio/aac\"", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/tts/tts-output-format.test.ts", line: 109, kind: "it", text: "\".flac\" -> \"audio/flac\"", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/skills/src/tools/integrations/tts/tts-output-format.test.ts", line: 113, kind: "it", text: "\".pcm\" -> \"audio/pcm\"", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  ...
  { file: "packages/web/src/app.test.ts", line: 387, kind: "it", text: "nulls apiClient", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/web/src/components/data/ic-stat-card.test.ts", line: 26, kind: "it", text: "renders label text", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/components/data/ic-stat-card.test.ts", line: 35, kind: "it", text: "renders value text", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/components/display/ic-connection-dot.test.ts", line: 65, kind: "it", text: "has role='status'", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/web/src/components/feedback/ic-confirm-dialog.test.ts", line: 44, kind: "it", text: "renders title text", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/components/feedback/ic-empty-state.test.ts", line: 85, kind: "it", text: "content is centered", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/web/src/components/feedback/ic-loading.test.ts", line: 81, kind: "it", text: "has role='status'", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/web/src/components/form/ic-array-editor.test.ts", line: 25, kind: "it", text: "renders label", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/web/src/components/form/ic-form-field.test.ts", line: 26, kind: "it", text: "renders label text", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/components/form/ic-json-editor.test.ts", line: 25, kind: "it", text: "renders label", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/web/src/components/form/ic-secret-input.test.ts", line: 25, kind: "it", text: "renders label", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/web/src/components/form/ic-secret-input.test.ts", line: 82, kind: "it", text: "disabled state", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/web/src/components/form/ic-select.test.ts", line: 31, kind: "it", text: "renders label text", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/components/form/ic-toggle.test.ts", line: 25, kind: "it", text: "renders label text", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/components/graph/ic-graph-canvas.test.ts", line: 60, kind: "it", text: "renders HTML layer", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/components/memory-detail.test.ts", line: 115, kind: "it", text: "renders agent ID", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/web/src/components/session/ic-session-row.test.ts", line: 77, kind: "it", text: "shows channel tag", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/web/src/router.test.ts", line: 74, kind: "it", text: "#/channels/telegram -> ic-channel-detail, params { type: 'telegram' }", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/web/src/router.test.ts", line: 107, kind: "it", text: "#/chat/sess-123 -> ic-chat-console, params { sessionKey: 'sess-123' }", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/web/src/router.test.ts", line: 162, kind: "it", text: "#/scheduler/cron-1 -> ic-scheduler-view, params { jobId: 'cron-1' }", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/web/src/state/graph-builder-state.test.ts", line: 136, kind: "it", text: "removes node by id", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/state/graph-builder-state.test.ts", line: 205, kind: "it", text: "removes edge by id", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/state/graph-builder-state.test.ts", line: 332, kind: "it", text: "updates viewport", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/web/src/styles/shared.test.ts", line: 7, kind: "it", text: "is a CSSResult", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/web/src/styles/shared.test.ts", line: 28, kind: "it", text: "is a CSSResult", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/web/src/styles/shared.test.ts", line: 49, kind: "it", text: "has exactly 7 keys", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/styles/shared.test.ts", line: 71, kind: "it", text: "is a CSSResult", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "packages/web/src/utils/cycle-detection.test.ts", line: 6, kind: "it", text: "detects self-loop", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/web/src/utils/edge-geometry.test.ts", line: 16, kind: "it", text: "NODE_WIDTH is 200", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/web/src/utils/edge-geometry.test.ts", line: 55, kind: "it", text: "contains C command", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/utils/edge-geometry.test.ts", line: 119, kind: "it", text: "default size is 8px", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/web/src/utils/edge-geometry.test.ts", line: 133, kind: "it", text: "custom size parameter works", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "packages/web/src/utils/extract-variables.test.ts", line: 38, kind: "it", text: "handles empty input", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "packages/web/src/utils/to-yaml.test.ts", line: 60, kind: "it", text: "skips empty arrays", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/utils/viewport-transform.test.ts", line: 24, kind: "it", text: "MIN_SCALE is 0.25", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/web/src/utils/viewport-transform.test.ts", line: 28, kind: "it", text: "MAX_SCALE is 2.0", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "packages/web/src/views/config-editor.test.ts", line: 228, kind: "it", text: "serializes arrays", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "packages/web/src/views/config-editor.test.ts", line: 239, kind: "it", text: "serializes null", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/web/src/views/config-editor.test.ts", line: 258, kind: "it", text: "parses arrays", reason: "Plan-40-10 captured (min-length=13); shrink in follow-on plan" },
  { file: "packages/web/src/views/config-editor.test.ts", line: 270, kind: "it", text: "parses null values", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/views/context-dag-browser.test.ts", line: 36, kind: "it", text: "has shadow root", reason: "Plan-40-10 captured (min-length=15); shrink in follow-on plan" },
  { file: "packages/web/src/views/models.test.ts", line: 231, kind: "it", text: "renders view title", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/views/models.test.ts", line: 479, kind: "it", text: "shows filter count", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/views/scheduler.test.ts", line: 143, kind: "it", text: "1 - renders 3 tabs", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "packages/web/src/views/security.test.ts", line: 197, kind: "it", text: "shows 7 tabs", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "packages/web/src/views/skills.test.ts", line: 198, kind: "it", text: "renders view title", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "test/architecture/no-cycles.test.ts", line: 188, kind: "it", text: "tsconfig refs + package.json @comis/* deps form an acyclic graph", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "test/integration/daemon-lifecycle.test.ts", line: 83, kind: "it", text: "logs daemon started", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "test/integration/daemon-shutdown.test.ts", line: 69, kind: "it", text: "gateway is running", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "test/integration/observability/log-redaction-live.test.ts", line: 79, kind: "it", text: "redacts apiKey", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "test/integration/secretmanager-lifecycle.test.ts", line: 65, kind: "it", text: "loadEnvFile -> assertEnvLoaded -> createSecretManager -> envSubset chain works", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "test/integration/security/ssrf-network-boundary.test.ts", line: 131, kind: "it", text: "blocks javascript:", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "test/integration/security/ssrf-network-boundary.test.ts", line: 143, kind: "it", text: "blocks data:", reason: "Plan-40-10 captured (min-length=12); shrink in follow-on plan" },
  { file: "test/integration/security/ssrf-network-boundary.test.ts", line: 236, kind: "it", text: "allows 1.1.1.1", reason: "Plan-40-10 captured (min-length=14); shrink in follow-on plan" },
  { file: "test/integration/subagent-pipeline.test.ts", line: 368, kind: "it", text: "depth limit enforcement", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "test/integration/system-lifecycle.test.ts", line: 199, kind: "it", text: "RPC-scope token accesses REST (200)", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
  { file: "test/support/architecture-allowlist.test.ts", line: 90, kind: "it", text: "no duplicate L-IDs", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "test/support/event-awaiter.test.ts", line: 32, kind: "it", text: "rejects on timeout", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "test/support/event-awaiter.test.ts", line: 80, kind: "it", text: "collects N events", reason: "Plan-40-10 captured (min-length=17); shrink in follow-on plan" },
  { file: "test/support/event-awaiter.test.ts", line: 175, kind: "it", text: "rejects on timeout", reason: "Plan-40-10 captured (min-length=18); shrink in follow-on plan" },
  { file: "test/support/log-verifier.test.ts", line: 53, kind: "it", text: "handles empty input", reason: "Plan-40-10 captured (min-length=19); shrink in follow-on plan" },
  { file: "test/support/log-verifier.test.ts", line: 103, kind: "it", text: "matches by level", reason: "Plan-40-10 captured (min-length=16); shrink in follow-on plan" },
  { file: "test/support/metric-aggregator.test.ts", line: 311, kind: "it", text: "multi-provider isolation", reason: "Plan-40-10 captured (use-case-shape heuristic miss); shrink in follow-on plan" },
] as const;
