...
export const fileSizeAllowlist: readonly FileSizeAllowlistEntry[] = [
  ...
  // api/*-handlers.ts split into per-domain modules)
  {
    ...
    lines: 2521, // re-measured post-collapse (Plan 59-03)
...
export const testNamingAllowlist: readonly TestNamingAllowlistEntry[] = [
  ...
  { file: "packages/core/src/config/schema-agent.test.ts", line: 722, kind: "it", text: "rejects empty id", reason: "Captured(min-length=16); shrink in follow-on work"},
  ...
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 199, kind: "it", text: "accepts 'pipeline'", reason: "Captured(min-length=18); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 204, kind: "it", text: "accepts 'dag'", reason: "Captured(min-length=13); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 220, kind: "it", text: "defaults to 10", reason: "Captured(min-length=14); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 314, kind: "it", text: "defaults to 15", reason: "Captured(min-length=14); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 458, kind: "it", text: "defaults to 5", reason: "Captured(min-length=13); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 497, kind: "it", text: "defaults to 2", reason: "Captured(min-length=13); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 521, kind: "it", text: "defaults to 8", reason: "Captured(min-length=13); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 550, kind: "it", text: "defaults to 0.75", reason: "Captured(min-length=16); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 579, kind: "it", text: "defaults to 8", reason: "Captured(min-length=13); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 608, kind: "it", text: "defaults to 4", reason: "Captured(min-length=13); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 637, kind: "it", text: "defaults to 2", reason: "Captured(min-length=13); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 666, kind: "it", text: "defaults to 0", reason: "Captured(min-length=13); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 695, kind: "it", text: "defaults to 20000", reason: "Captured(min-length=17); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 724, kind: "it", text: "defaults to 1200", reason: "Captured(min-length=16); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 753, kind: "it", text: "defaults to 2000", reason: "Captured(min-length=16); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 782, kind: "it", text: "defaults to 4000", reason: "Captured(min-length=16); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 811, kind: "it", text: "defaults to 10", reason: "Captured(min-length=14); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 840, kind: "it", text: "defaults to 120000", reason: "Captured(min-length=18); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 869, kind: "it", text: "defaults to 25000", reason: "Captured(min-length=17); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 898, kind: "it", text: "defaults to 15", reason: "Captured(min-length=14); shrink in follow-on work"},
  { file: "packages/core/src/config/schema-context-engine.test.ts", line: 927, kind: "it", text: "defaults to 200000", reason: "Captured(min-length=18); shrink in follow-on work"},
  ...
  { file: "packages/skills/src/platform-tools/tool-helpers.test.ts", line: 287, kind: "it", text: "returns valid value", reason: "Captured(min-length=19); shrink in follow-on work"},
  ...
  { file: "packages/skills/src/platform-tools/tools/unified-memory-tool.test.ts", line: 69, kind: "it", text: "passes custom limit", reason: "Captured(min-length=19); shrink in follow-on work"},
  { file: "packages/skills/src/platform-tools/tools/unified-session-tool.test.ts", line: 57, kind: "it", text: "passes custom limit", reason: "Captured(min-length=19); shrink in follow-on work"},
